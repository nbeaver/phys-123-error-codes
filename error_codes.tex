...
\begin{enumerate}[start=30]
  ...
  \item Equation is numbered, but formatting is wrong.
...
\begin{enumerate}[start=40]
  ...
  % TODO: Rule of thumb: if you used a number, you need to say where it came from.
  % TODO: Don't include the numbers you measured in your procedure.
  %       They should go in a table or graph instead.
\end{enumerate}
...
\begin{enumerate}[start=80]
  ...
  \item Graph plots data versus itself or a transformation of itself.
    This may give an $R^2 = 1$, but it does not mean anything.
...
\begin{enumerate}[start=130]
  ...
  \item Rounding error is not an acceptable reason for systematic error
    ...
    will result in negligibly small rounding error.
  \item Do not average uncertainties.
    Since you don't expect them to have a central tendency,
    the arithmetic mean is not meaningful.
\end{enumerate}
